 ...
 * tokens and convert them to to types and strings.
...
public final class StdIn {
    ...
    public static char readChar() {
        try {
            ...
            throw new NoSuchElementException("attempts to read a 'char' value from standard input, but there are no " +
    ...
    public static String readString() {
        try {
            ...
            throw new NoSuchElementException("attempts to read a 'String' value from standard input, but there are no" +
                    " more tokens available");
        }
    }
    ...
    public static int readInt() {
        try {
            ...
            throw new InputMismatchException("attempts to read an 'int' value from standard input, but the next token" +
                    " is \"" + token + "\"");
        } catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemps to read an 'int' value from standard input, but there are no " +
                    "more tokens available");
        }
    ...
    public static double readDouble() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'double' value from standard input, but the next " +
                    "token is \"" + token + "\"");
        } catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'double' value from standard input, but there are no" +
                    " more tokens available");
        }
    }
    ...
    public static float readFloat() {
        try {
            ...
            throw new NoSuchElementException("attempts to read a 'float' value from standard input, but there are no " +
                    "more tokens available");
        }
    }
    ...
    public static long readLong() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'long' value from standard input, but the next token" +
                    " is \"" + token + "\"");
        } catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'long' value from standard input, but there are no " +
                    "more tokens available");
        }
    }
    ...
    public static short readShort() {
        try {
            ...
            throw new NoSuchElementException("attempts to read a 'short' value from standard input, but there are no " +
                    "more tokens available");
        }
    }
    ...
    public static byte readByte() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'byte' value from standard input, but the next token" +
                    " is \"" + token + "\"");
        } catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'byte' value from standard input, but there are no " +
                    "more tokens available");
        }
    }
    ...
    public static boolean readBoolean() {
        try {
            ...
            throw new InputMismatchException("attempts to read a 'boolean' value from standard input, but the next " +
                    "token is \"" + token + "\"");
        } catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'boolean' value from standard input, but there are " +
    ...
    public static int[] readLineInts() {
