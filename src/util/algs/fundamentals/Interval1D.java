package util.algs.fundamentals;
...
public class Interval1D {
    ...
    public static void main(String[] args) {
        ...
        StdOut.println("AbstractSort by min endpoint");
        ...
        StdOut.println("AbstractSort by max endpoint");
        ...
        StdOut.println("AbstractSort by length");
